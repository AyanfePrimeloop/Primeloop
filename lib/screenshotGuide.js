...
export const PLATFORM_GUIDE = {
  facebook: [
    ...
    { action: 'share', mock: 'share', how: 'Tap Share. Then go to your own profile/timeline and screenshot the post appearing there — not the original post itself.' },
  ],
  instagram: [
    ...
    { action: 'share', mock: 'share', how: 'Share it to your Story, or repost to your grid — then screenshot it there, not the original post.' },
  ],
  tiktok: [
    ...
    { action: 'follow', mock: 'follow', how: 'Tap Follow on the profile, then screenshot the button once it changes to "Following".' },
    { action: 'share', mock: 'share', how: 'Tap Share → Repost, then screenshot it appearing on your own profile — not the original video.' },
  ...
  x: [
    ...
    { action: 'repost', mock: 'share', how: 'Tap Repost and confirm it, then screenshot it appearing on your own profile/timeline — not the original post.' },
