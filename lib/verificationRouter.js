...
// Always AI-checked in trust_based mode, even for trusted engagers:
//  - follow / subscribe pay the most and are the easiest to fake;
//  - comment / reply are where quality shows: a generic or one-word comment is
//    exactly what a client does not want, and only reading the text catches it.
const HIGH_VALUE_ACTIONS = new Set(['follow', 'subscribe', 'comment', 'reply']);
 ...
 *                     is AI-checked as a spot check. Follows, subscribes,
 *                     comments and replies are always AI-checked. The AI never rejects on its own here:
